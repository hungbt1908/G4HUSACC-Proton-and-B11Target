...
ProtonInelasticXS::ProtonInelasticXS()
...
G4bool 
ProtonInelasticXS::IsElementApplicable(
...
G4double ProtonInelasticXS::GetElementCrossSection(
			     const G4DynamicParticle* aPart, 
			     G4int Z, const G4Material*)
{
...
G4double ProtonInelasticXS::GetProtonCrossSection(
