...
//
//
// GEANT4 physics class: ProtonElasticXS -- header file
...
#ifndef ProtonElasticXS_h
#define ProtonElasticXS_h 1

#include <vector>
#include "Randomize.hh"
#include "G4VCrossSectionDataSet.hh"

class ProtonElasticXS : public G4VCrossSectionDataSet
{
public:

  ProtonElasticXS();               // Constructor

  ~ProtonElasticXS();

  static const char* Default_Name() {return "ChipProtonElasticXS";}
